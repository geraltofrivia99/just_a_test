...
export const getPhones = (state, ownProps) => {
    const activeCategoryId = getActiveCatigoryId(ownProps)
...
export const getCatigories = state => R.values(state.catigories)

export const getActiveCatigoryId = ownProps => 
